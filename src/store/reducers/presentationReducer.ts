import {Presentation, Primitive, Slide as TSlide, TextContent} from "../../types/types";
import {
    ADD_ITEM,
    ADD_ITEM_PRIMITIVE,
    ADD_ITEM_TEXT,
...
function applyTextMutation(state: Presentation, key: keyof TextContent["data"], value: boolean | string) {
    return {
        ...state,
...
const presentationReducer = (state = initialPresentationState, action: PresentationActionTypes): Presentation => {
    switch (action.type) {
        ...
        case SET_FONT_UNDERLINED:
            return applyTextMutation(state, "fontUnderline", action.payload)
        case SET_FONT_STRIKETHROUGH:
            return applyTextMutation(state, "fontStrikeThrough", action.payload)
        case SET_FONT_COLOR:
            return applyTextMutation(state, "fontColor", action.payload)
        case EDIT_TEXT_ITEM:
            return {
                ...state,
                presentationSlides: state.presentationSlides.map(slide => {
