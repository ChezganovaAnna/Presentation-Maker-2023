...
const base64Likeable: ImageContent = {
    type: "image",
    id: uuidv4(),
    position: {
        x: 100,
    ...
    data: {
        ...
        pathImage: "https://citaty.info/files/characters/138610.jpg",
        alt: "first-image",
    },
}
...
const slides1: Slide = {
    ...
    objects: [myLovelyImage, base64Likeable, textCont, circle1, rectangle1, triangle1, textCont1],
